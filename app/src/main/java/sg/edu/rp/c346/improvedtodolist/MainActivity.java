...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Calendar d1 = Calendar.getInstance(); // Create a calender object with current
        d1.set(2016,10,1); //Set it to new date
        ToDoItem item1 = new ToDoItem("MSA", d1, true); //Create a ToDoItem object named item
